...
public class DatasetEmbedded implements Serializable {
	...
	@ElementCollection
	private List<DatafileEmbedded> datafiles = new ArrayList<DatafileEmbedded>();
	
	public DatasetEmbedded() {
	}
	...
	public List<DatafileEmbedded> getDatafiles() {
		return datafiles;
	}

	public void setDatafiles(List<DatafileEmbedded> datafiles) {
